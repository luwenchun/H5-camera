!function (e) {
    ...
    [
        ...
        function (e, t, n) {
            ...
            a.active = !1, a.webcam = null, a.canvas = null, a.ctx = null, a.decoder = null, a.setCanvas = function () {
                ...
                a.init = function () {
                    ...
                    window.iOS || navigator.mediaDevices.enumerateDevices().then(function (e) {
        ...
        function (e, t) {
            function n() {
                return "serviceWorker" in navigator && (window.fetch || "imageRendering" in document.documentElement.style)
                /*&& ("https:" === window.location.protocol || "localhost" === window.location.hostname || 0 === window.location.hostname.indexOf("127."))*/
            }
            ...
            "serviceWorker" in navigator && navigator.serviceWorker.ready.then(function (e) {
                ...
                function o() {
                    window.iOS || (m.style.display = "block"), i.default.scan(function (e) {
                        r = e, y.innerHTML = e, /* y.select(),*/ m.style.display = "none", (0, d.default)(e) && (v.style.display = "inline-block"), u.classList.remove("app__dialog--hide"), p.classList.remove("app__dialog--hide")
                    })
                }
